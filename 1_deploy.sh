...
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-2/service-a.yaml --context $ap2
...
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/dc2_default/service-a.yaml --context $dc2
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/dc2_default/service-b-v1.yaml --context $dc2
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/dc2_default/service-c-v1.yaml --context $dc2

kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/dc2_default/igw.yaml --context $dc2

kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/dc2_default/intentions.yaml --context $dc2
#################### Peer dc1-tentant-2 to dc2-default ##################
#create an acceptor in tenant-2
kubectl apply -f  /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/peering/acceptor-on-ap2-for-dc2.yaml --context $ap2
...
kubectl apply -f  /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/peering/dialer-dc2.yaml --context $dc2
#export services from dc2 to dc1 
kubectl apply -f  /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/peering/exported.yaml --context $dc2
...
# kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-2/service-b-router-header.yaml --context $ap2
# kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-2/service-b-router-query.yaml --context $ap2

# kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-1/service-a-router-header.yaml --context $ap1
#################### Router ##################
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-1/service-a-router-query.yaml --context $ap1
#################### Splitter ##################
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-2/service-b-splitter.yaml --context $ap2

#################### Resolver ##################
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-1/service-a-resolver.yaml --context $ap1
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-1/service-a-resolver.yaml --context $ap2
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-1/service-b-resolver.yaml --context $ap2
kubectl apply -f /Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/tenant-1/service-c-resolver.yaml --context $ap2
