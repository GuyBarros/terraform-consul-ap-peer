...
kubectl apply -f  ./deployments/hashicups_full/routes-ginx-teal.yaml --context $ap1
...
kubectl apply -f  ./deployments/hashicups_full/routes-ginx-teal.yaml --context $dc1