...
export dc1=arn:aws:eks:eu-west-2:958215610051:cluster/cluster1-eks-vJkWTP4W
export ap1=arn:aws:eks:eu-west-2:958215610051:cluster/cluster2-eks-20Wnk5iw
export ap2=arn:aws:eks:eu-west-2:958215610051:cluster/cluster3-eks-pJiAg021
...
kubectl create secret generic documentdb-tls -n consul  --from-file=caFile=/Users/guybarros/GIT_ROOT/terraform-consul-ap-peer/deployments/default_test/rds-combined-ca-bundle.pem --context $dc1
