...
export dc1=arn:aws:eks:eu-west-2:958215610051:cluster/cluster1-eks-wsZJyfmL
...
# Install Consul
helm install consul hashicorp/consul --namespace consul --values /Users/guybarros/GIT_ROOT/BT_ARCAM/dc1.yaml --wait --debug --kube-context $dc1
helm upgrade consul hashicorp/consul --namespace consul --values /Users/guybarros/GIT_ROOT/BT_ARCAM/dc1.yaml --wait --debug --kube-context $dc1
